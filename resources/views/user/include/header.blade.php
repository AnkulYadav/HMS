        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 text-sm">
                    <div class="site-info">
                        <a href="tel:9336879087"><span class="mai-call text-primary"></span> +91 9336879087</a>
                        <span class="divider">|</span>
                        <a href="mailto:ankulyadav9001@gmail.com"><span class="mai-mail text-primary"></span>
                            ankulyadav9001@gmail.com</a>
                        @if (Route::has('login'))
                            @auth
                                <div class="btn-group" role="group" style="color: white;">
                                    <a class="btn btn-primary" style="color: white;margin-left: 10px;margin-right: 10px"
                                        href="{{ route('myquery') }}">My Query</a>

                                    <div class="btn-group">
                                        <button type="button" style="background-color: #00D9A5;"
