                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <select name="speciality" id="inputSpeciality" class="form-select" style="width: 100%;">
                                        ...
                                        @foreach ($doctors as $do)
                                            <option value="{{ $do->speciality }}"
                                                @if ($doctor->speciality == $do->speciality) selected @endif>{{ $do->speciality }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control"value="{{ $doctor->room }}" id="inputPassword" name="room"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control"value="{{ $doctor->time }}" id="inputPassword" name="time"
                                        type="text" placeholder="Schedule Time" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control"value="{{ $doctor->day }}" id="inputPassword" name="day"
                                        type="text" placeholder="Schedule Day" />
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-floating mb-3 mb-md-0">
                                    <input class="form-control"value="{{ $doctor->fee }}" id="inputPassword" name="fee"
